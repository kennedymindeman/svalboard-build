...
- [thecore-overview](/thecore-overview.md) — What the channel is, how TheCore went from JaKaTaK's 5.0/6.x releases to the community-maintained "Juuce" v6 files, who answers questions, and what the distillation does not cover.

## Choosing and editing a layout
...
- [learning-and-practice](/learning-and-practice.md) — How to learn the layout, adaptation timelines, drills, when to switch mid-ladder, and the "start on standard first?" debate.
- [patches-and-timeline](/patches-and-timeline.md) — Dated SC2 patches and TheCore releases that changed hotkeys, and the channel's news from 2019 to 2026.

## Reference

- [faq](/faq.md) — Newcomer questions asked more than once, with the channel's answers and how they changed.
- [open-questions](/open-questions.md) — Contested or unresolved topics: layout philosophy, maintenance after JaKaTaK, unbound commands in regional files, hardware trade-offs.
- [links](/links.md) — Repos, Drive folders, spreadsheets, videos, forum threads and tools cited in the channel.
